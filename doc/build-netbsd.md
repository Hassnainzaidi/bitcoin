...
This guide describes how to build viraliumd, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run viraliumd or the GUI.
