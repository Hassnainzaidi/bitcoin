...
For instance:
    ...
    $ viraliumd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubhashblock="tcp://[::1]:28333" \
               -zmqpubrawtx=ipc:///tmp/viraliumd.tx.raw \
...
From the perspective of viraliumd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into viraliumd directly. Furthermore, no information is
...
using. viraliumd appends an up-counting sequence number to each
