...
| *libbitcoin_node*        | P2P and RPC server functionality used by *viraliumd* and *bitcoin-qt* executables. |
| *libbitcoin_util*        | Home for common functionality shared by different executables and libraries. Similar to *libbitcoin_common*, but lower-level (see [Dependencies](#dependencies)). |
| *libbitcoin_wallet*      | Wallet functionality used by *viraliumd* and *bitcoin-wallet* executables. |
| *libbitcoin_wallet_tool* | Lower-level wallet functionality used by *bitcoin-wallet* executable. |
| *libbitcoin_zmq*         | [ZeroMQ](../zmq.md) functionality used by *viraliumd* and *bitcoin-qt* executables. |
...
viraliumd[viraliumd]-->libbitcoin_node;
viraliumd[viraliumd]-->libbitcoin_wallet;
...
class bitcoin-qt,viraliumd,bitcoin-cli,bitcoin-wallet bold
```
</td></tr><tr><td>
