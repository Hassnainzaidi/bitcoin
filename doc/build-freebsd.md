...
This guide describes how to build viraliumd, command-line utilities, and GUI on FreeBSD.
...
#### Wallet Dependencies
It is not necessary to build wallet functionality to run either `viraliumd` or `bitcoin-qt`.
