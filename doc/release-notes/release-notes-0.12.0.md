...
This allows running viraliumd without having to do any manual configuration.
...
viraliumd can now (optionally) asynchronously notify clients through a
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ...
        # optional bypass viraliumd rpc basic auth
...
Restarting viraliumd will no longer clear out the list of banned peers; instead
...
- #7209 `f3ad812` test: don't override viraliumd and BITCOINCLI if they're set (Wladimir J. van der Laan)
...
- #6401 `6db53b4` Add viraliumd_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
...
- #6504 `b6fee6b` Rationalize currency unit to "VIR" (Ross Nicoll)
