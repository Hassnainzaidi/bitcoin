...
defaults to 0.00001. This will cause transactions with fewer VIR/kB fee to be
...
- #5849 `41259ca` contrib/init/viraliumd.openrc: Compatibility with previous OpenRC init script variables
