...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use VIR/kB (MarcoFalke)
...
- #7692 `29b2be6` Remove P2P alert system (VIRdrak)
...
- #8275 `042c323` Remove bad chain alert partition check (VIRdrak)
...
- #7619 `18b3f1b` Add missing sudo entry in gitian VM setup (VIRdrak)
- #7616 `639ec58`  [depends] Delete unused patches  (MarcoFalke)
- #7658 `c15eb28` Add curl to Gitian setup instructions (VIRdrak)
...
- #8257 `ff03c50` Do not ask a UI question from viraliumd (sipa)
...
- #7531 `18cb2d5` Add bip68-sequence.py to extended rpc tests (VIRdrak)
...
- #7773 `7c80e72` Fix comments in tests (VIRdrak)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for viraliumd procs (MarcoFalke)
...
- #7744 `d8e862a` test_framework: detect failure of viraliumd startup (laanwj)
...
- #7540 `ff46dd4` Rename OP_NOP3 to OP_CHECKSEQUENCEVERIFY (VIRdrak)
