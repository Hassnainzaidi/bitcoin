...
- A new `-asmap` configuration option has been added to diversify the
  ...
  `viraliumd help` for more information.  This option is experimental and
...
- #18341 Replace remaining literal VIR with `CURRENCY_UNIT` (domob1812)
...
- #16115 On viraliumd startup, write config args to debug.log (LarryRuane)
