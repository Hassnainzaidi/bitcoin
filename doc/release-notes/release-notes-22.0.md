...
- Passing an invalid `-rpcauth` argument now cause viraliumd to fail to start.  (#20461)
...
### RPC and other APIs
- bitcoin/bitcoin#18335, bitcoin/bitcoin#21484 cli: Print useful error if viraliumd rpc work queue exceeded (LarryRuane)
...
- bitcoin/bitcoin#20884 script: Improve robustness of viraliumd.service on startup (hebasto)
...
- bitcoin/bitcoin#21007 viraliumd: Add -daemonwait option to wait for initialization (laanwj)
