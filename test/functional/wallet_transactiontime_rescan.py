...
class TransactionTimeRescanTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine VIR and create transactions
        ...
        # generate some VIR to create transactions and check blockcount
        ...
        # send 10 VIR to user's first watch-only address
        self.log.info('Send 10 VIR to user')
        ...
        # send 5 VIR to our second watch-only address
        self.log.info('Send 5 VIR to user')
        ...
        # send 1 VIR to our third watch-only address
        self.log.info('Send 1 VIR to user')
