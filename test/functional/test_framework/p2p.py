...
"""Test objects for interacting with a viraliumd node over the p2p protocol.

The P2PInterface objects interact with the viraliumd nodes under test using the
