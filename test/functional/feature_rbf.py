...
class ReplaceByFeeTest(BitcoinTestFramework):
    ...
    def test_simple_doublespend(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {tx.hash}; new feerate 0.00300000 VIR/kvB <= old feerate 0.00300000 VIR/kvB"
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 VIR - so this attempt is rejected.
