...
complete --command viraliumd --no-files

# Extract options
function __fish_viraliumd_get_options
...
complete \
    --command viraliumd \
    --arguments "(__fish_viraliumd_get_options --nofiles)"
