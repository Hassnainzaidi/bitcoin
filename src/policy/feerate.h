...
const std::string CURRENCY_UNIT = "VIR"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    VIR_KVB,      //!< Use VIR/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::VIR_KVB) const;
